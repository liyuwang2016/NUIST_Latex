...
\newcommand{\sihao}{\fontsize{14pt}{17.5pt}\selectfont} % 四号，1.25 倍行距
\newcommand{\xiaosi}{\fontsize{12pt}{15pt}\selectfont}  % 小四，1.25 倍行距
\newcommand{\dawu}{\fontsize{10.5pt}{18pt}\selectfont}  % 五号，1.75 倍行距
...
\fancyhf{}
\fancyhead[CO]{\song\wuhao{南京信息工程大学硕士学位论文}}
...
\def\teacher#1{\def\@teacher{#1}}\def\@teacher{} %改这边定义要改5 处，这里3 处，下面1 处，cover里1处
\def\theauthor#1{\def\@theauthor{#1}}\def\@theauthor{}
\def\themajor#1{\def\@themajor{#1}}\def\@themajor{}
...
\centering
\begin{tabular}{ll}
分类号：\_\_\_\_\_\_\_\_\_\_\_\_\_\_   & ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ 单位代码：\_\_\_\_\_\_\_\_\_\_\_\_\_\_       \\
密~~~~级：\_\_\_\_\_\_\_\_\_\_\_\_\_\_ & ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ 学~ ~ ~ ~ 号：\_\_\_\_\_\_\_\_\_\_\_\_\_\_
\end{tabular}
\end{table}
...
\end{figure*}
      ...
      \parbox[t][0.40cm][c]{\textwidth} %这里的0.4控制图片最下边到下面字的最上边的距离
      {
        \begin{center}
      ...
      \parbox[b][8.39cm][c]{\textwidth}
      {
        \vspace{3.8cm} %控制和上一个模块中心行的距离
        \begin{center}
          {
            \xiaosan\song
            \begin{tabular}{p{0.6cm}p{6.4em}@{\extracolsep{0.5em}}lc}
              \vspace{-0.41cm}
              ~ & 申 \hfill 请 \hfill 人 \hfill 姓 \hfill 名：& \fixedunderlineleft[6.08cm]{\@theauthor} & \\
              \vspace{-0.41cm}
              ~ & 指 \hfill 导 \hfill \hfill 教 \hfill 师：& \fixedunderlineleft[6.08cm]{\@teacher} & \\
              \vspace{-0.41cm}
              ~ & 专 \hfill 业 \hfill 名 \hfill 称：& \fixedunderlineleft[6.08cm]{\@themajor} & \\
              \vspace{-0.41cm}
              ~ & 研 \hfill 究 \hfill 方 \hfill 向：& \fixedunderlineleft[6.08cm]{\@direction} & \\
              \vspace{-0.41cm}
              ~ & 所 \hfill 在 \hfill 学 \hfill 院：& \fixedunderlineleft[6.08cm]{\@college} & \\
              \vspace{-0.41cm}
            \end{tabular}
          }
        \end{center}
...
%  \begin{center}
    \parbox[t][2.52cm][c]{\textwidth}
    {\xiaoer\song\centerline{\textbf{独创性声明}}}
    \parbox[t][8.68cm][c]{\textwidth}
    {
      \sihao\fs\noindent

~~~~~~本人声明所呈交的论文是我个人在导师指导下进行的研究工作及取得的研究成果。%
本论文除了文中特别加以标注和致谢的内容外，不包含其他人或其他机构己经发表或撰写过的研宄成果，也不包含为获得南京信息工程大学或其他教育机构的学位或证书而使用过的材料。其他同志对本研究所做的贡献均己在论文中作了声明并表示谢意。%

学位论文作者签名：\underline{\hspace{2.4cm}}~~~~~~~ 签字日期：\underline{\hspace{2.4cm}}
}
%  \end{center}
...
\begin{center}
    ...
    {\xiaoer\song\centerline{\textbf{关于论文使用授权的说明}}}
    \parbox[t][8.68cm][c]{\textwidth}
    {
      \sihao\fs\noindent

~~~~~~南京信息工程大学、国家图书馆、中国学术期刊（光盘版）杂志社、中国科学技术信息研宄所的《中国学位论文全文数据库》有权保留本人所送交学位论文的复印件和电子文档，可以采用影印、缩印或其他复制手段保存论文，并通过网络向社会提供信息服务。本人电子文档的内容和纸质论文的内容相一致。除在保密期内的保密论文外，允许论文被查阅和借阅，可以公布（包括刊登）论文的全部或部分内容。论文的公布（包括刊登）授权南京信息工程大学研究生院办理。

学位论文作者签名：\underline{\hspace{2.4cm}}~~~~~~~ 签字日期：\underline{\hspace{2.4cm}}

~~~~~~~~指导教师签名：\underline{\hspace{2.4cm}}~~~~~~~ 签字日期：\underline{\hspace{2.4cm}}
}
  \end{center}

  \renewcommand{\baselinestretch}{1.27}
%  \cleardoublepage %偶数页空白
}
...
\def\makeabstract{
  ...
  \addcontentsline{toc}{chapter}{摘　　要} %目录里加入一个章节摘要，但不编号
  \setcounter{page}{1}
  \@cabstract
  \vspace{0.53cm}
...
%  \cleardoublepage %偶数页空白
  ...
  \vspace{-1.40cm}
  \begin{center}
 %   {\xiaosan\textrm{\@etitle}} %我们南信大英文摘要不需要英文标题
